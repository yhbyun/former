	...
	protected function mockConfig(array $options = array())
	{
		...
		$options = array_merge($defaults, array(
			...
			'TwitterBootstrap3.viewports'         => array(
      		...
      		'TwitterBootstrap3Validator.icon.prefix'       => 'glyphicon',
      		'TwitterBootstrap3Validator.icon.set'          => 'glyphicon',
      		'TwitterBootstrap3Validator.icon.tag'          => 'span',
      		'TwitterBootstrap3Validator.labelWidths'       => array('large' => 2, 'small' => 4),
      		'TwitterBootstrap3Validator.viewports'         => array(
      			'large'  => 'lg',
      			'medium' => 'md',
      			'small'  => 'sm',
      			'mini'   => 'xs',
			...
			'ZurbFoundation.viewports'            => array(
				'large'  => '',
				'medium' => null,
				'small'  => 'mobile-',
				'mini'   => null,
			...
			'ZurbFoundation4.viewports'           => array(
				'large'  => 'large',
				'medium' => null,
				'small'  => 'small',
				'mini'   => null,
